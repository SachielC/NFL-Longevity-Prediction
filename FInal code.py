...
draft2023 = {
    ...
    'anthony_richardson' : [[76, 244, 20.2, 32.75, 4.43, 40.5, 0, 0], 'QB'],
    'devon_witherspoon' : [[72, 181, 22.4, 31.25, 4.45, 0, 0, 0], 'CB'],
    ...
    'Puka' : [[69, 182, 23, 29.25, 4.42, 35.5, 0, 0], "WR"]
}
draft2022 = {
    'travon_walker' : [[77, 272, 21, 35.5, 4.51, 35.5, 0, 4.32], 'DE'],
    'aidan_hutchinson' : [[79, 260, 22, 32.125, 4.74, 36, 0, 4.15], 'DE'],
    'derek_stingley_jr' : [[72, 190, 20, 30.75, 4.37, 0, 0, 0], 'CB'],
    'sauce_gardner' : [[75, 190, 20, 33.5, 4.41, 0, 0, 0], 'CB'],
    'kayvon_thibodeaux' : [[76, 254, 21, 33.125, 4.58, 0, 27, 0], 'DE'],
